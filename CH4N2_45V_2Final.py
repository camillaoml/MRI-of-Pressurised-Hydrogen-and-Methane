...
# Settings
# -------------------------------------------------
ARRANGEMENT_CHANGE_SCAN = 127
EXCLUDE_SCANS = []

TIME_TICK_STEP = 12   # change to 4 if you want denser ticks

# -------------------------------------------------
# 1. Read Excel
# -------------------------------------------------
file_path = r"/Users/camillaomland/Library/CloudStorage/OneDrive-UniversityofBergen/MRI_H2/Code/diffusion/CH4_diff_experiments/CH4_N2_120_diff45V2_diffusion_results_lang.xlsx"
...
#
# IMPORTANT:
# The ROI extraction script already used SWAP_ROIS_AFTER_FLIP = True.
# Therefore, ROI1 is already CH4 and ROI2 is already N2
# both before and after flipping.
...
# Midpoint between scan 127 and the next valid scan
# -------------------------------------------------
...
save_plot(fig, "H1_concentration_CH4_N2_120_45V2_long_configuration_regions.png")
...
add_combined_legend_below(fig, include_ch4=True, include_n2=True)
save_plot(fig, "signal_CH4_N2_120_45V2_long_configuration_regions.png")
...
save_plot(fig, "initial_N2_H1_concentration_CH4_N2_120_45V2_long_configuration_regions.png")
...
save_plot(fig, "initial_CH4_H1_concentration_CH4_N2_120_45V2_long_configuration_regions.png")
...
corrected_excel_path = os.path.join(
    output_folder,
    "CH4_N2_120_45V2_long_plot_data_H1_concentration_configuration_regions.xlsx"
)
...
if arrangement_change_time is not None:
    ...
    print("\nNo arrangement-change scan was found. Background regions were not added.")